...
SecurityUser.add({
  ...
  investingWallet: { type: Types.Relationship, ref: 'MainWallet', required: true, initial: true, index: true, filters: { owner: ':objectId', type: 'INVESTING' } },
  personalWallet: { type: Types.Relationship, ref: 'MainWallet', required: true, initial: true, index: true, filters: { owner: ':objectId', type: 'PERSONAL' } }
})
