...
/**
 * Предоставляет новые blockchain-адреса площадки.
 * Для генерации используется bip44. Seed key из конфигов.
 */
class AddressProvider {
  ...
  /**
   * Генерирует следующий адрес площадки.
   * @see {@link PlatformAddress}
   */
  async nextAddress () {
